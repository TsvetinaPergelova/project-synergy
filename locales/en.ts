...
export const en = {
  ...
  account: {
    actionTooltipKey: "New translation",
    typeKey: "Current account for individuals",
  },
  transaction: {
    paymentTypeKey: "Transfer order",
    payerName: "Philip Iliev Philipov",
  },
  ...
  dashboardHeader: {
    ...
    settingsMenuItems: {
      ...
      smsCardNotifications: "SMS Card Notifications",
      emailSMSNotifications: "Email/SMS Notifications",
      changePINToken: "Change PIN Token",
      unblockToken: "Unblock Token",
      registerKEP: "Register KEP",
      registerCertificate: "Register Certificate",
      changePassword: "Change Password",
      security3D: "3D card security",
    ...
    notificationsItems: {
      ...
      /* more notifications..*/
      creditRepaymentTitle: "Credit Repayment",
      creditRepaymentDesc: "5 days left to pay the installment on the loan...",
      tokenActivatedDesc: "You can now use your Token device for...",
      tokenActivatedTitle: "Token device successfully activated.",
      newCardAuthDesc: "100 BGN were withdrawn from card 401820***2251.",
      newCardAuthTitle: "New Card Authorization",
    },
    ...
    profileDropdown: {
      userLabel: "User:",
      clientLabel: "Client:",
      selectOtherClientLabel: "Select Other Client:",
    },
  },
  loginPage: {
  ...
  dashboardPage: {
    ...
    tableHeaderCreditType: "Credit Type",
